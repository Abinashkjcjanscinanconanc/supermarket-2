...
public class UpdateAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 410, 100, 30));
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
       ...
       else
       {
           try{
               ...
               String q="Update admin set adminname='"+uName.getText()+"'"+",adminpass='"+uPassword.getText()+"'"+"where adminid="+1;
